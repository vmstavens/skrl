...
class XPose(mjx_env.MjxEnv):
    ...
    def init(self) -> mj.MjModel:
        ...
        <option iterations="1" ls_iterations="5" timestep="0.004" integrator="implicitfast">
            ...
            <actuator>
                <position name="x" joint="x" ctrlrange="-1 1" kp="1" kv="10" ctrllimited="true"/>
                <position name="y" joint="y" ctrlrange="-1 1" kp="1" kv="10" ctrllimited="true"/>
                <position name="z" joint="z" ctrlrange="-1 1" kp="1" kv="10" ctrllimited="true"/>
            </actuator>
        </mujoco>
        """
