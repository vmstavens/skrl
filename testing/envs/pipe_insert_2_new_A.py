...
class PipeInsert2(mjx_env.MjxEnv):
    ...
    def __init__(
        ...
        self._termination_threshold = 0.01
    ...
    def _get_done(self, data: mjx.Data, info: dict) -> float:
        ...
        d = self._from_to(data, _from=self.keypoint_id, _to=self.target_id)

        d_norm = jp.linalg.norm(d)

        success = d_norm < self._termination_threshold
