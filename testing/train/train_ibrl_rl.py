...
# from testing.shen.IBRL import IBRL, IBRL_DEFAULT_CONFIG
from testing.shen.ibrl_rl import IBRL_RL, IBRL_RL_DEFAULT_CONFIG
...
cfg_IBRL["experiment"]["experiment_name"] = Path(__file__).stem + "_rl"
...
cfg = {"timesteps": 35_000, "headless": False}
