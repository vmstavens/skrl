...
from testing.experiments.pipe_insert.V3.train_sac import (
...
def _latest_sac_checkpoint(runs_dir: Path) -> Path:
    return Path(
        "testing/experiments/pipe_insert/V3/.runs/train_sac_actor_sac__warmup_timesteps_0__soft_update_beta_0.2_20260402_17_44_56/models/train_sac_actor_sac__warmup_timesteps_0__soft_update_beta_0.2_20260402_17_44_56/checkpoints/best_agent.pt"
    )
    patterns = [
...
class Args:
    ...
    record_path: Optional[Path] = Path(
        "testing/experiments/pipe_insert/V3/data/rollout_sac_test.json"
    )
