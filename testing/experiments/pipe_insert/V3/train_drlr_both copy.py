"""Clean IBRL + DP training script using V3 PipeInsert2."""
...
class Args:
    ...
    expert_data_dir: Path = Path("testing/experiments/pipe_insert/V3/demos")
    ...
    action_trans_high: Optional[float] = 0.001 * 3
    action_trans_low: Optional[float] = -0.001 * 3
    action_rot_high: Optional[float] = 0.005 * 3
    action_rot_low: Optional[float] = -0.005 * 3
...
def main(args: Optional[Args] = None) -> None:
    ...
    cfg["il_ctrl_scale"] = args.il_action_scale
    cfg["rl_ctrl_scale"] = args.rl_action_scale
