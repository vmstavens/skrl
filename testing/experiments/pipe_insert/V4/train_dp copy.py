...
class Args:
    ...
    data_dir: Path = Path("testing/experiments/pipe_insert/V3/datasets/subsample_x4")
...
def main(args: Optional[Args] = None) -> None:
    ...
    dp_config["experiment"]["experiment_name"] = "pipe_insert_2_rot_mocap"
