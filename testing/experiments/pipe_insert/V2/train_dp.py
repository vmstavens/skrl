...
from testing.experiments.pipe_insert.V2.utils import get_dp_config, setup_environment
...
@dataclass
class Args:
    """Train DP policy (rotation) on the mocap dataset."""

    # data_dir: Path = Path("testing/experiments/pipe_insert/V2/demos")
    data_dir: Path = Path("testing/experiments/pipe_insert/V2/datasets/subsample_x4")
