...
@dataclass
class Args:
    input_dir: Path = Path("testing/experiments/pipe_insert/V2/demos")
    output_dir: Path = Path("testing/experiments/pipe_insert/V2/datasets")
    stride: int = 4
    suffix: str = ""
...
def main(args: Args | None = None) -> None:
    ...
    dataset_name = f"subsample_x{args.stride}_2"
    if args.suffix:
